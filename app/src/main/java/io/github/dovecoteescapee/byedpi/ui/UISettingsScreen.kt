...
fun UISettingsScreen(
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                PreferenceCategory(title = stringResource(R.string.byedpi_desync))
            ...
            item {
                PreferenceCategory(title = stringResource(R.string.byedpi_protocols_category))
            ...
            item {
                PreferenceCategory(title = stringResource(R.string.desync_http_category))
            ...
            item {
                PreferenceCategory(title = stringResource(R.string.desync_https_category))
            ...
            item {
                PreferenceCategory(title = stringResource(R.string.desync_udp_category))
